    ...
    <div class="container h-100">
      <div class="row">
        <div class="d-flex justify-content-center h-100">
          ...
          <input ref="search_input" v-model="searhTextModel" v-on:keypress="autoSearch()" class="search_input" type="search" placeholder="Поиск по содержимому документа" />
      ...
      <div class="row">
        <div class="list-group">
          <ResultFulltextSearchItem v-for="result in results" :resultItem="result" :itemType="itemType" />
        </div>
      </div>
    </div>
  </div>
...
import ResultFulltextSearchItem from "./ResultFulltextSearchItem.vue";
import {ipcRenderer} from "electron";
import {renderAsync} from "docx-preview";

export default defineComponent ({
  name: "FulltextSearchPage",
  components: {
    ResultFulltextSearchItem
  },
  data() {
    return {
